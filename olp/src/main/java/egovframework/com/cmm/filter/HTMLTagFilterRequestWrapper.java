...
//	static private String[] whiteListTag = { "<br>" };
	static private String[] whiteListTag = { "<p>", "</p>", "<br>" };
	
	static private String[] blackListTag = {  "<script", "</script>", "&lt;script", "&lt;/script&gt;"
	...
	public String[] getParameterValues(String parameter) {
		...
		for (int i = 0; i < values.length; i++) {
			if (values[i] != null) {
				values[i] = checkBlackListTag(values[i]);
	...
	private String checkBlackListTag(String data) {
		for(String blackListData : blackListTag) {
			data = data.replaceAll(blackListData, blackListData.replace("</", ""));
			data = data.replaceAll(blackListData, blackListData.replace("<", ""));
			data = data.replaceAll(blackListData, blackListData.replace("&lt;", ""));
		}
		return data;
