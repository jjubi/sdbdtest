...
//        model.addAttribute("message", egovMessageSource.getMessage("success.common.select"));
        ...
        return "egovframework/com/sec/rmt/EgovRoleManage.adm";
	}
	...
	public String selectRole(@RequestParam("roleCode") String roleCode,
        ...
        model.addAttribute("roleTypeComCodeList", comCodeService.selectComCodeList("ROLE_TYPE"));

        return "egovframework/com/sec/rmt/EgovRoleUpdate.adm";
	}
    ...
    public String insertRoleView(@ModelAttribute("authorManageVO") AuthorManageVO authorManageVO,
        ...
        return "egovframework/com/sec/rmt/EgovRoleInsert.adm";
    }
