...
<div class="container-fluid">
	...
	<div class="card">
		<div class="card-body">
			<h1 class="h1"><spring:message code="comUssUmt.deptUserManage.title" /> ${pageTitle}</h1>
					...
					<div class="form-horizontal contents-form">
						...
						<div class="form-group">
							<div class="col-sm-12 col-md-2 control-label col-lg-2">
								...
								<label for="emplyrId">${title } </label>
							</div>
							<div class="col-sm-12 col-md-10">
								<input type="text" name="emplyrId" id="emplyrId" value="<c:out value='${userManageVO.emplyrId}'/>" class="form-control" title="사용자아이디" size="20" maxlength="20" readonly/>
