...
<div class="container-fluid">
	...
	<div class="card">
		<div class="card-body">
			...
			<form:form commandName="cntntsVO" action="${pageContext.request.contextPath}/cmmn/adm/cntnts/insertCntnts.do" method="post" enctype="multipart/form-data" onsubmit="return false;">
				<div class="card-wrap">
					<div class="form-horizontal contents-form">
						...
						<div class="form-group">
							...
							<div class="col-sm-12 col-md-10">
								<form:textarea path="cntntsCn" class="form-control summernoteArea" title="${title} ${inputTxt}" cols="30" rows="10" />
				...
				<div class="card-wrap-footer">
					...
					<div class="float-right">
						<button type="submit" id="cntntsRegistBtn" class="btn btn-basic" title="<spring:message code="button.create" /> <spring:message code="input.button" />">
