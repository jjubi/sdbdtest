...
<div class="container-fluid">
	...
	<div class="card">
		<div class="card-body">
			...
			<form:form commandName="qestnarVO" action="${pageContext.request.contextPath}/cmmn/adm/qestnar/updateQestnar.do" method="post" onsubmit="return false;">
				<form:hidden path="qestnarSeqNo"/>
				<div class="card-wrap">
					<div class="form-horizontal contents-form">
						...
						<div class="form-group">
							...
							<div class="col-sm-12 col-md-10">
								<textarea id="qestnarPrface" name="qestnarPrface" class="form-control summernoteArea" title="${title} ${inputTxt}" cols="30" rows="10" ><c:out value="${qestnarVO.qestnarPrface }" escapeXml="false"/></textarea>
						...
						<div class="form-group">
							...
							<div class="col-sm-12 col-md-10">
								<textarea id="qestnarCnclsn" name="qestnarCnclsn" class="form-control summernoteArea" title="${title} ${inputTxt}" cols="30" rows="10" ><c:out value="${qestnarVO.qestnarCnclsn }" escapeXml="false"/></textarea>
						...
						<div class="form-group">
							...
							<div class="col-sm-12 col-md-10">
								<label class="radio-inline" for="qestnarTrgetY">
                                	<form:radiobutton path="qestnarTrget" id="qestnarTrgetY" value="ALL" /> 전체
                                </label>
						...
						<div class="form-group" id="qestnarTrgetListDiv" style="display: ${qestnarVO.qestnarTrget eq 'ALL' ? 'none' : 'flex'};">
							<div class="col-sm-12 col-md-2 control-label col-lg-2">
							...
							<div class="col-sm-12 col-md-10">
								...
								<div class="input-group btn_target">
									...
									<div class="boxOn target_wrap">
										<c:if test="${not empty qestnarVO.qestnarTrgetList }">
											<c:forEach items="${qestnarVO.qestnarTrgetList }" var="qestnarTrgetVO" varStatus="status">
												<p>
													<span class="label label-default">
														<c:out value="${qestnarTrgetVO.mberNm }" />
														<span class="target_close">
									    					<i class="fas fa-times"></i>
									    				</span>
										        		<input type="hidden" name="userId" value="<c:out value="${qestnarTrgetVO.esntlId }"/>">
										        		<input type="hidden" name="userNm" value="<c:out value="${qestnarTrgetVO.mberNm }"/>">
										        	</span>
												</p>
											</c:forEach>
										</c:if>
						...
						<div class="form-group">
							...
							<div class="col-sm-12 col-md-10">
								<label class="radio-inline" for="qestnarDplctAtY">
                                	<form:radiobutton path="qestnarDplctAt" id="qestnarDplctAtY" value="Y" /> 허용
                                </label>
						...
						<div class="form-group">
							...
							<div class="col-sm-12 col-md-10">
                                ...
                                <label class="radio-inline" for="qestnarPgeAtN">
                                	<form:radiobutton path="qestnarPgeAt" id="qestnarPgeAtN" value="N" /> 사용안함
                                </label>
							</div>
						</div>
						<div class="form-group">
                            ...
                            <div class="col-sm-12 col-md-10">
                                <label class="radio-inline" for="useAtY">
                                	<form:radiobutton path="useAt" id="useAtY" value="Y" /> 사용
                                </label>
				...
				<div class="card-wrap-footer">
					...
					<div class="float-right">
						<button type="button" id="qestnarDeleteBtn" class="btn btn-danger" title="<spring:message code="button.delete" /> <spring:message code="input.button" />">
							<spring:message code="button.delete" /><!-- 삭제 -->
						</button>
						<button type="submit" id="qestnarUpdateBtn" class="btn btn-warning" title="<spring:message code="button.update" /> <spring:message code="input.button" />">
