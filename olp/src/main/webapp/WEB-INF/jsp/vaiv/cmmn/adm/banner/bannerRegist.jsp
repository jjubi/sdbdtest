...
<div class="container-fluid">
	...
	<div class="card">
		<div class="card-body">
			...
			<form:form commandName="bannerVO" action="${pageContext.request.contextPath}/cmmn/adm/banner/insertBanner.do" method="post" enctype="multipart/form-data" onsubmit="return false;">
				<div class="card-wrap">
				...
				<div class="card-wrap-footer">
					...
					<div class="float-right">
						<button type="submit" id="bannerRegistBtn" class="btn btn-basic" title="<spring:message code="button.create" /> <spring:message code="input.button" />">
