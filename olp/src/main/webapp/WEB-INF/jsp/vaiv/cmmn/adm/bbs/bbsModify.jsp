...
<div class="container-fluid">
	...
	<div class="card">
		<div class="card-body">
			...
			<form:form commandName="bbsVO" action="${pageContext.request.contextPath}/cmmn/adm/bbs/updateBbs.do" method="post" onsubmit="return false;">
				<div class="card-wrap">
					<div class="form-horizontal contents-form">
						<c:set var="inputTxt"><spring:message code="input.input" /></c:set>
						<div class="form-group">
							<div class="col-sm-12 col-md-2 control-label col-lg-2">
								<c:set var="title"><spring:message code="vaivBbs.regist.bbsId" /></c:set>
								<label for="bbsId">${title } <span class="pilsu">*</span></label>
							</div>
						...
						<div class="form-group">
							...
							<div class="col-sm-12 col-md-10">
								<form:input path="bbsNm" class="form-control" title="${title} ${inputTxt}" size="40" maxlength="200" />
						...
						<div class="form-group">
							...
							<div class="col-sm-12 col-md-4">
								<label class="radio-inline" for="bbsPdUseAtY">
                                	<form:radiobutton path="bbsPdUseAt" id="bbsPdUseAtY" value="Y" /> 사용
                                </label>
                                <label class="radio-inline" for="bbsPdUseAtN">
                                	<form:radiobutton path="bbsPdUseAt" id="bbsPdUseAtN" value="N" /> 사용안함
                                </label>
							</div>
							<div class="col-sm-12 col-md-2 control-label col-lg-2 bbsPdDateArea" style="display : ${bbsVO.bbsPdUseAt eq 'Y' ? 'block' : 'none'};">
								<c:set var="title"><spring:message code="vaivBbs.regist.bbsPd" /></c:set>
								<label for="bbsPdBgnde">${title } </label>
							</div>
							<div class="col-sm-12 col-md-4 bbsPdDateArea" style="display : ${bbsVO.bbsPdUseAt eq 'Y' ? 'block' : 'none'};">
				...
				<div class="card-wrap-footer">
					...
					<div class="float-right">
						<button type="button" id="bbsDeleteBtn" class="btn btn-danger" title="<spring:message code="button.delete" /> <spring:message code="input.button" />">
							<spring:message code="button.delete" /> <!-- 삭제 -->
						</button>
						<button type="submit" id="bbsUpdateBtn" class="btn btn-warning" title="<spring:message code="button.update" /> <spring:message code="input.button" />">
