...
<div class="container-fluid">
	...
	<div class="card">
		<div class="card-body">
			...
			<form:form commandName="comCodeVO" action="${pageContext.request.contextPath}/cmmn/adm/comCode/updateComCode.do" method="post" onsubmit="return false;">
				<div class="card-wrap">
				...
				<div class="card-wrap-footer">
					...
					<div class="float-right">
						<button type="button" id="comCodeDeleteBtn" class="btn btn-danger" title="<spring:message code="button.delete" /> <spring:message code="input.button" />">
							<spring:message code="button.delete" /><!-- 삭제 -->
						</button>
						<button type="submit" id="comCodeUpdateBtn" class="btn btn-warning" title="<spring:message code="button.update" /> <spring:message code="input.button" />">
