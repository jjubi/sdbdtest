...
function init(){
	...
	var confmKey = "devU01TX0FVVEgyMDIxMDIxNTEzNTAzNDExMDgwNzE="; // 개발 ( 사용기간 : 2021-02-15 ~ 2021-05-16 )
	...
	if(inputYn != "Y"){
		...
		//document.form.action="http://10.182.60.20/addrlink/addrLinkUrl.do"; //행정망 80 행정망일 경우 변경하여 사용하도록 한다.
		//document.form.action="https://10.182.60.20/addrlink/addrLinkUrl.do"; //행정망 443
