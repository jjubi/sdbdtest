...
<%
 /**
  * @Jsp Name : bbstBasic > nttAnswerRegist.jsp
  * @상세설명 : basic 게시물 답글 등록 페이지 
  * @작성일시 : 2020. 12. 31
  * @작 성 자 : jo
  * @수 정 이 력
  * @
...
<div class="container-fluid">
	...
	<div class="card">
		<div class="card-body">
			<h1 class="h1">${pageTitle} <spring:message code="title.reply" /> <small>( ${nttVO.nttSj } )</small></h1>
			<form:form commandName="nttAnswerVO" action="${pageContext.request.contextPath}/cmmn/adm/bbs/ntt/${bbsId}/insertNtt.do" method="post" enctype="multipart/form-data" onsubmit="return false;">
				<div class="card-wrap">
					<div class="form-horizontal contents-form">
						...
						<div class="form-group">
							...
							<div class="col-sm-12 col-md-10">
								<form:input path="nttSj" class="form-control" title="${title} ${inputTxt}" size="40" maxlength="300" value="RE:${nttVO.nttSj }"/>
