...
<div class="container-fluid">
	...
	<div class="card">
		<div class="card-body">
			...
			<form:form commandName="bbsTyVO" action="${pageContext.request.contextPath}/cmmn/adm/bbs/ty/insertBbsTy.do" method="post" onsubmit="return false;">
				<div class="card-wrap">
				...
				<div class="card-wrap-footer">
					...
					<div class="float-right">
						<button type="submit" id="bbsTyRegistBtn" class="btn btn-basic" title="<spring:message code="button.create" /> <spring:message code="input.button" />">
