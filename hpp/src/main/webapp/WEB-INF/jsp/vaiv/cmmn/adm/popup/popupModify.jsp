...
<div class="container-fluid">
	...
	<div class="card">
		<div class="card-body">
			...
			<form:form commandName="popupVO" action="${pageContext.request.contextPath}/cmmn/adm/popup/updatePopup.do" method="post"  enctype="multipart/form-data" onsubmit="return false;">
				<form:hidden path="popupSeqNo" />
							...
							<div class="col-sm-12 col-md-10">
								<div class="row">
									<div class="col-sm-12 col-md-6">
	       							...
	       							<div class="col-sm-12 col-md-6">
		       							<c:if test="${not empty popupVO.atchFileId }">
											<img id="preViewImageArea" src="${pageContext.request.contextPath }/cmm/fms/getImage.do?atchFileId=${popupVO.atchFileId}&amp;fileSn=0" height="50">
										</c:if>
										<c:if test="${empty popupVO.atchFileId }">
				...
				<div class="card-wrap-footer">
					...
					<div class="float-right">
						<button type="button" id="popupDeleteBtn" class="btn btn-danger" title="<spring:message code="button.delete" /> <spring:message code="input.button" />">
							<spring:message code="button.delete" /><!-- 삭제 -->
						</button>
						<button type="submit" id="popupUpdateBtn" class="btn btn-warning" title="<spring:message code="button.update" /> <spring:message code="input.button" />">
