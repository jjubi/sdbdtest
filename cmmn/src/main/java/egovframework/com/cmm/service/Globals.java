...
public class Globals {
    ...
    //파일 업로드 허용 확장자 목록
    public static final String FILE_UPLOAD_EXTS = EgovProperties.getProperty("Globals.fileUpload.Extensions");
    //파일 다운로드 허용 확장자 목록
    public static final String FILE_DOWNLOAD_EXTS = EgovProperties.getProperty("Globals.fileDownload.Extensions");
    //ShellFile 경로
