...
public interface EgovFileMngService {
     ...
     * @throws Exception
     */
    public List<FileVO> selectFileInfs(FileVO fvo) throws SQLException;
     ...
     * @throws Exception
     */
    public String insertFileInf(FileVO fvo) throws SQLException;
     ...
     * @throws Exception
     */
    public String insertFileInfs(List<?> fvoList) throws SQLException;
     ...
     * @throws Exception
     */
    public void updateFileInfs(List<?> fvoList) throws SQLException;
     ...
     * @throws Exception
     */
    public void deleteFileInfs(List<?> fvoList) throws SQLException;
     ...
     * @throws Exception
     */
    public Map<String, Object> selectFileListByFileNm(FileVO fvo) throws SQLException;
