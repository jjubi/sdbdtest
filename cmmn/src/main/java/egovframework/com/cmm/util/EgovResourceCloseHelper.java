		...
		for (Closeable resource : resources) {
			if (resource != null) {
				try {
					...
					new Loggable().logging("Occurred IOException to close resource is ingored!!");
				} catch (Exception ignore) {
					new Loggable().logging("Occurred Exception to close resource is ingored!!");
				}
			}
		}
	}
			...
			if (object != null) {
				if (object instanceof ResultSet) {
					try {
						...
						new Loggable().logging("Occurred SQLException to close resource is ingored!!");
					} catch (Exception ignore) {
						new Loggable().logging("Occurred Exception to close resource is ingored!!");
					}
