...
public class SysLog implements Serializable{
	...
	/**
	 * @return the requstUri
	 */
	public String getRequstUri() {
		return requstUri;
	}
	/**
	 * @param requstUri the requstUri to set
	 */
	public void setRequstUri(String requstUri) {
		this.requstUri = requstUri;
	}
	/**
	 * @return the requstDomn
	 */
	public String getRequstDomn() {
		return requstDomn;
	}
	/**
	 * @param requstDomn the requstDomn to set
	 */
	public void setRequstDomn(String requstDomn) {
		this.requstDomn = requstDomn;
	}
	/**
