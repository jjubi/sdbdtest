...
public class EgovMberManageController {
	...
	public String selectMberList(@ModelAttribute("userSearchVO") UserDefaultVO userSearchVO, ModelMap model) throws Exception {
		...
		List<ComCodeVO> mberSttus_result = comCodeService.selectComCodeList("USER_STATUS");
		model.addAttribute("mberSttus_result", mberSttus_result);//일반회원상태코드목록

		return "egovframework/com/uss/umt/EgovMberManage.adm";
	}
...
//		model.addAttribute("groupId_result", groupId_result); //그룹정보 목록
		...
		return "egovframework/com/uss/umt/EgovMberInsert.adm";
	}
...
//		model.addAttribute("groupId_result", groupId_result); //그룹정보 목록
		...
		return "egovframework/com/uss/umt/EgovMberSelectUpdt.adm";
	}
...
//		vo.setCodeId("COM014");
		...
		return "egovframework/com/uss/umt/EgovMberSbscrb.adm";
	}
	...
	public String sbscrbEntrprsMber(Model model) throws Exception {
		...
		return "egovframework/com/uss/umt/EgovStplatCnfirm.adm";
	}
	...
	public String updatePassword(ModelMap model, @RequestParam Map<String, Object> commandMap, @ModelAttribute("searchVO") UserDefaultVO userSearchVO,
		...
		return "egovframework/com/uss/umt/EgovMberPasswordUpdt.adm";
	}
