...
public class EgovClntInfo {
	 ...
	 * @exception Exception
	*/
	public static String getClntIP(HttpServletRequest request) throws RuntimeException {
	 ...
	 * @exception Exception
	*/
//	public static String getClntOsInfo(HttpServletRequest request) throws RuntimeException {
//	
...
//	}
	 ...
	 * @exception Exception
	*/
	public static String getClntWebKind(HttpServletRequest request) throws RuntimeException {
	 ...
	 * @exception Exception
	*/
	public static String getClntWebVer(HttpServletRequest request) throws RuntimeException {
